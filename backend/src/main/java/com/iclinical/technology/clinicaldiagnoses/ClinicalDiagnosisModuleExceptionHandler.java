...
@RestControllerAdvice(basePackages = "com.iclinical.technology.clinicaldiagnoses")
class ClinicalDiagnosisModuleExceptionHandler {

    @ExceptionHandler(ClinicalDiagnosisNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    ApiError handleNotFound(ClinicalDiagnosisNotFoundException exception) {
        return new ApiError(exception.getMessage(), Map.of());
    }

    @ExceptionHandler(ClinicalDiagnosisValidationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    ApiError handleValidation(ClinicalDiagnosisValidationException exception) {
        return new ApiError(exception.getMessage(), Map.of());
    }
