...
@RestControllerAdvice(basePackages = "com.iclinical.technology.diagnosiscatalog")
class DiagnosisCatalogModuleExceptionHandler {

    @ExceptionHandler(DiagnosisCatalogNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    ApiError handleNotFound(DiagnosisCatalogNotFoundException exception) {
        return new ApiError(exception.getMessage(), Map.of());
    }

    @ExceptionHandler(DiagnosisCatalogValidationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    ApiError handleValidation(DiagnosisCatalogValidationException exception) {
        return new ApiError(exception.getMessage(), Map.of());
    }
