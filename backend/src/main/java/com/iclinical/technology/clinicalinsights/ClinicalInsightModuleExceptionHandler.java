...
@RestControllerAdvice(basePackages = "com.iclinical.technology.clinicalinsights")
class ClinicalInsightModuleExceptionHandler {

    @ExceptionHandler(ClinicalInsightNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    ApiError handleNotFound(ClinicalInsightNotFoundException exception) {
        return new ApiError(exception.getMessage(), Map.of());
    }

    @ExceptionHandler(ClinicalInsightValidationException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    ApiError handleValidation(ClinicalInsightValidationException exception) {
        return new ApiError(exception.getMessage(), Map.of());
    }
